...
public:
	...
	HitLine* GetHitLineSpri3() { return m_p_hit_line_spri3; }
	bool GetCrearCnt3() { return m_CrearCnt3; }
...
private:
	...
	HitLine* m_p_hit_line_spri3;//当たり判定
};