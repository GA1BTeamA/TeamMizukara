...
CWTM3::CWTM3(float x, float y,int color)
	:m_x(x), m_y(y), m_wave_x(x+6), m_wave_y(y+35), m_ani_time1(0.0f), m_ani_time2(0.0f)
	, im_x(x), im_y(y-50), m_water_x(x+3), m_water_y(y+135), m_water_remaining(1.4)
	,m_gx(x),m_gy(y+65)
{
	if (color == 74)
	{
	...
	m_p_hit_line_wtm3->SetPos2(m_x+20, m_y + 100);
...
void CWTM3::Action()
{
	...
	m_p_hit_line_wtm3->SetPos2(m_x+20 + ground->GetScroll(), m_y + 100);
}
