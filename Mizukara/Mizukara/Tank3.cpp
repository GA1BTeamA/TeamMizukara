...
const float CTank3::m_WaveSize_x = 0.2f;
const float CTank3::m_WaveSize_y = 0.2f;

CTank3::CTank3()
	:m_x(40), m_y(250), m_wave_x(11), m_wave_y(/*249.27*/249.3)
...
void CTank3::Draw()
{
	...
	//水表示
	Draw::Draw2D(48, m_water_x + ground3->GetScroll(), m_water_y-8, 0.108, -(0.18*m_water_remaining2 *0.02));
}
