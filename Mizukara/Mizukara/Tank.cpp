...
//const float CTank::m_Wave_Shrinking = 1;
...
void CTank::Draw()
{
    ...
    if (m_ani_time1 < 10)
	{
		Draw::Draw2D(36, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 20)
	{
		Draw::Draw2D(37, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 30)
	{
		Draw::Draw2D(38, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 40)
	{
		Draw::Draw2D(39, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 50)
	{
		Draw::Draw2D(40, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 60)
	{
		Draw::Draw2D(41, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 70)
	{
		Draw::Draw2D(42, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 80)
	{
		Draw::Draw2D(43, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 90)
	{
		Draw::Draw2D(44, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 100)
	{
		Draw::Draw2D(45, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time1 < 110)
	{
		Draw::Draw2D(46, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	...
	if (m_ani_time2 < 5)
	{
		Draw::Draw2D(25, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 10)
	{
		Draw::Draw2D(26, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 15)
	{
		Draw::Draw2D(27, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 20)
	{
		Draw::Draw2D(28, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 25)
	{
		Draw::Draw2D(29, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 30)
	{
		Draw::Draw2D(30, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 35)
	{
		Draw::Draw2D(31, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 40)
	{
		Draw::Draw2D(32, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 45)
	{
		Draw::Draw2D(33, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 50)
	{
		Draw::Draw2D(34, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
	else if (m_ani_time2 < 55)
	{
		Draw::Draw2D(35, m_x1 + ground->GetScroll(), m_y1, 1, 1);
	}
