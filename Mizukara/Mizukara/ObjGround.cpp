...
void CObjGround::Action()
{
	...
	m_p_hit_line_ground[1]->SetPos1(m_scroll + 500, m_gy + 1350);
	m_p_hit_line_ground[1]->SetPos2(m_scroll + 500, m_gy + 1500);
	m_p_hit_line_ground[2]->SetPos1(m_scroll + 500, m_gy + 1350);
	m_p_hit_line_ground[2]->SetPos2(m_scroll + 600, m_gy + 1350);
	m_p_hit_line_ground[3]->SetPos1(m_scroll + 600, m_gy + 320);
	...
	m_p_hit_line_ground[8]->SetPos2(m_scroll + 1307-10, m_gy + 237);
	m_p_hit_line_ground[9]->SetPos1(m_scroll + 1307-10, m_gy + 264);
	m_p_hit_line_ground[9]->SetPos2(m_scroll + 1307-10, m_gy + 237);
	m_p_hit_line_ground[10]->SetPos1(m_scroll + 1207-10, m_gy + 264);
	m_p_hit_line_ground[10]->SetPos2(m_scroll + 1333-10, m_gy + 264);
	m_p_hit_line_ground[11]->SetPos1(m_scroll + 1333-10, m_gy + 291);
	m_p_hit_line_ground[11]->SetPos2(m_scroll + 1333-10, m_gy + 264);
	m_p_hit_line_ground[12]->SetPos1(m_scroll + 1233-10, m_gy + 291);
	m_p_hit_line_ground[12]->SetPos2(m_scroll + 1359-10, m_gy + 291);
	m_p_hit_line_ground[13]->SetPos1(m_scroll + 1359-10, m_gy + 318);
	m_p_hit_line_ground[13]->SetPos2(m_scroll + 1359-10, m_gy + 291);
	m_p_hit_line_ground[14]->SetPos1(m_scroll + 1259-10, m_gy + 318);
	m_p_hit_line_ground[14]->SetPos2(m_scroll + 1385-10, m_gy + 318);
	m_p_hit_line_ground[15]->SetPos1(m_scroll + 1385-10, m_gy + 318);
	m_p_hit_line_ground[15]->SetPos2(m_scroll + 1385-10, m_gy + 346);
	m_p_hit_line_ground[16]->SetPos1(m_scroll + 1285-10, m_gy + 346);
	m_p_hit_line_ground[16]->SetPos2(m_scroll + 1411-10, m_gy + 346);
	m_p_hit_line_ground[17]->SetPos1(m_scroll + 1411-10, m_gy + 346);
	m_p_hit_line_ground[17]->SetPos2(m_scroll + 1411-10, m_gy + 373);
	m_p_hit_line_ground[18]->SetPos1(m_scroll + 1311-10, m_gy + 373);
	m_p_hit_line_ground[18]->SetPos2(m_scroll + 1437-10, m_gy + 373);
	m_p_hit_line_ground[19]->SetPos1(m_scroll + 1437-10, m_gy + 373);
	m_p_hit_line_ground[19]->SetPos2(m_scroll + 1437-10, m_gy + 400);
	m_p_hit_line_ground[20]->SetPos1(m_scroll + 1337-10, m_gy + 400);
	m_p_hit_line_ground[20]->SetPos2(m_scroll + 2400, m_gy + 400);
