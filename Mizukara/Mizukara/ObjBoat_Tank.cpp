...
ObjBoat_Tank::ObjBoat_Tank()
	:m_x(276), m_y(400), m_gx(275), m_gy(330), m_wave_x(292), m_wave_y(350),m_wave_x2(272),m_wave_y2(400),m_move_x(0.0f),
	m_ani_time1(0.0f), m_ani_time2(0.0f), m_ani_time3(0.0f), m_WaveSize_y(0.5f)
...
void ObjBoat_Tank::Action()
{
	...
	//if (m_WaveSize_y > 0.2f)m_WaveSize_y = 0.6f;
